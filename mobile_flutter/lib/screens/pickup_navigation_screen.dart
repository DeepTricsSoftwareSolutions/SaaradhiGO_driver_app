...
class _PickupNavigationScreenState extends State<PickupNavigationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final driverLocation = (rideProvider.currentLat != null && rideProvider.currentLng != null) 
            ...
            Positioned(
              ...
              child: FadeInDown(
                child: Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.access_time, color: AppTheme.primaryGold, size: 16),
                      const SizedBox(width: 8),
                      Text(etaText, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              ),
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text('${ride['riderRating'] ?? 4.9}', style: const TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w900)),
                                        ],
                                      ),
                                    ),
                                    const SizedBox(width: 8),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            "₹${ride['fare']}",
                            style: const TextStyle(color: AppTheme.primaryGold, fontSize: 16, fontWeight: FontWeight.w900, fontStyle: FontStyle.italic),
                          ),
                          const SizedBox(width: 4),
                          Text(
                            (ride['paymentMode'] ?? 'UPI').toUpperCase(),
                            style: const TextStyle(color: Colors.white24, fontSize: 8, fontWeight: FontWeight.w900),
                          ),
                        ],
                      ),
                    ),
                    ...
                    DriverButton(
                      onPressed: () {
                        ...
                        if (isArrived) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('You are still too far from the pickup location (>150m).'),
                      ...
                      child: const Column(
                        ...
                        children: [
                          Text("ARRIVED AT PICKUP", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                          Text(
