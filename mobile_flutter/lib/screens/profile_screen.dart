  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AuthBloc, AuthState>(
      builder: (context, state) {
        ...
        final name = user['full_name'] ?? 'Driver Name';
              ...
              children: [
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(
                              colors: [AppTheme.primaryGold, AppTheme.primaryGold.withValues(alpha: 0.1)],
                            ),
                          ),
                          child: CircleAvatar(
                            radius: 60,
                            ...
                            child: Text(
                              ...
                              style: const TextStyle(color: AppTheme.primaryGold, fontSize: 48, fontWeight: FontWeight.w900),
                            ),
                          ),
                        ),
                        const SizedBox(height: 20),
                        ...
                        const Text(
                          ...
                          style: TextStyle(color: AppTheme.primaryGold, fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 2),
                        ),
                      ],
                    ),
                  ),
                ...
                FadeInUp(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text(
                        "MANAGEMENT",
                        style: TextStyle(color: Colors.white38, fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 2.5),
                      ),
                      ...
                      GlassCard(
                        ...
                        child: Column(
                          children: [
                            _buildProfileMenuItem(Icons.account_balance_wallet_rounded, "Earnings & Wallet", () => Navigator.pushNamed(context, '/wallet')),
                            _buildProfileMenuItem(Icons.history_rounded, "Trip History", () => Navigator.pushNamed(context, '/earnings')),
                            _buildProfileMenuItem(Icons.verified_user_rounded, "KYC Documents", () {}),
                            _buildProfileMenuItem(Icons.help_center_rounded, "Support Center", () {}),
                          ],
                        ),
                      ),
                    ],
                ...
                FadeInUp(
                  ...
                  child: DriverButton(
                    ...
                    child: const Text("LOGOUT SESSION", style: TextStyle(color: AppTheme.errorRed)),
                  ),
                ),
