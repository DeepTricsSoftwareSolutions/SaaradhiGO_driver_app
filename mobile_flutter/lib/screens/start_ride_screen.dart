...
class _StartRideScreenState extends State<StartRideScreen> {
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        IconButton(
                          ...
                          icon: const Icon(Icons.arrow_back_ios_new, color: AppTheme.primaryGold, size: 24),
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(ride['riderName'], style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w900, color: Colors.white)),
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        const Icon(Icons.star, color: AppTheme.successGreen, size: 12),
                                        const SizedBox(width: 4),
                                        Text("${ride['riderRating']} RATING", style: const TextStyle(color: AppTheme.successGreen, fontSize: 10, fontWeight: FontWeight.w900)),
                                      ],
                                    ),
                                  ),
                                ],
                          ...
                          Row(
                            ...
                            children: [
                              _buildQuickInfo(Icons.directions_car_outlined, "Economy"),
                              _buildQuickInfo(Icons.account_balance_wallet_outlined, "${ride['paymentMode']} Payment"),
                            ],
                          ),
                        ],
                      ),
                  ...
                  if (_waitSeconds < 300)
                    ...
                    FadeIn(
                      child: Column(
                        children: [
                          const Text("5 Minutes Passed. Rider not here?", style: TextStyle(color: Colors.redAccent, fontWeight: FontWeight.bold)),
                        ...
                        child: Column(
                          children: [
                            ...
                            TextField(
                              ...
                              style: const TextStyle(fontSize: 48, fontWeight: FontWeight.w900, color: Colors.white, letterSpacing: 16),
                              onChanged: (v) => setState(() {}),
                              decoration: InputDecoration(
                                counterText: "",
                                hintText: "0 0 0 0",
                                hintStyle: TextStyle(color: Colors.white.withValues(alpha: 0.2), letterSpacing: 16),
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  const Row(
                                    children: [
                                      Icon(Icons.verified_user_outlined, color: AppTheme.primaryGold, size: 16),
                                      SizedBox(width: 8),
                                      Text(
                                        "SAFE RIDE",
                            ...
                            DriverButton(
                              onPressed: _otpController.text.length == 4 && !provider.isLoading 
                              ...
                              child: provider.isLoading 
                                ...
                                : const Text("START TRIP", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900)),
                            ),
                          ],
                        ),
                      ),
  ...
  Widget _buildProgressDot(Color color) {
    return Container(width: 24, height: 6, decoration: BoxDecoration(color: color, borderRadius: BorderRadius.circular(100)));
  }
