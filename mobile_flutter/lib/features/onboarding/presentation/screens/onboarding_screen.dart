  ...
  Future<void> _submitRegistration() async {
    ...
    try {
      final formData = FormData.fromMap({
        ...
        'vehicleCapacity': _capacityController.text,
        'submit': 'true',
      });
      ...
      await appendFile('profilePhoto', _profilePhoto);
      await appendFile('aadhaar', _docs['Aadhaar Card']);
      await appendFile('license', _docs['Driving License']);
      await appendFile('rc', _docs['Vehicle RC']);
      ...
      debugPrint('Backend upload failed, using demo mode: $e');
                  ...
                  return Expanded(
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color:
                            s <= _step ? AppTheme.primaryGold : Colors.white10,
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                _buildVehicleChoice(
                    "2W", Icons.motorcycle_outlined, "Bike / Moto"),
                const SizedBox(width: 16),
                _buildVehicleChoice(
                    "4W", Icons.directions_car_outlined, "Car / Cab"),
              ],
            ),
            const SizedBox(height: 40),
            _buildField(
              ...
              onChanged: (v) =>
                  setState(() => _vehicleNumController.text = v.toUpperCase()),
            ),
            const SizedBox(height: 24),
            _buildField(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            DriverButton(
              onPressed:
                  (_isStep3Valid() && !_isLoading) ? _submitRegistration : null,
              child: _isLoading
                  ? const SizedBox(
                      width: 24,
                      height: 24,
